...
int get_rev_for(int n){
    ...
    for ( int ten = 10; n6 != (n % 10) * 100000 ;){	//* создаем цикл для расчета первой цифры перевернутого числа,пока n6 не равно (n % 10)*100000
    ...
    if ( n6 != (n % 10) * 100000 ){	//* создаем условие , если n6 не равно (n % 10) * 100000
    	...
    	m = m + n6;	//* вписываем первую цифру в перевернутое число
    	}	//* условие завершено
    for ( int ten = 10; n5 != (n / 10 % 10) * 10000;){	//* создаем цикл для расчета второй цифры перевернутого числа
    ...
    for ( int ten = 10; n4 != (n / 100 % 10) * 1000;){	//* создаем цикл для расчета третьей цифры перевернутого числа
    ...
    for ( int ten = 10; n3 != (n / 1000 % 10) * 100;){	//* создаем цикл для расчета следующей цифры перевернутого числа
    ...
    for ( int ten = 10; n2 != (n / 10000 % 10) * 10;){	//* создаем цикл для расчета следующей цифры перевернутого числа
    ...
    for ( int ten = 10; n1 != n / 100000;){	//* создаем цикл для расчета последней цифры перевернутого числа
